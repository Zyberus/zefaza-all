...
class AppTheme {
  // Premium color scheme for services app
  static const Color primaryColor = Color(0xFF1E1E1E); // Dark charcoal
  static const Color accentColor = Color(0xFFD4AF37);  // Premium gold (matching other apps)
  ...
  // Dark theme (primary theme for the services app)
